...
<div id="core" class="container raster">
	...
	<ul id="portfolio-list" class="centerrow">
		...
		<li id="post-<?php the_ID(); ?>" class="centerfourcol item_full filter all <?php
		   ...
		   // Loop over each item since it's an array
			...
			unset($term);
                ...
                <img class="bags" src="<?php echo get_template_directory_uri(); ?>/js/timthumb.php?src=<?php echo $image[0]; ?>&amp;w=400&amp;h=200" alt="<?php the_title(); ?>"/>
                <?php }?>
                </a>      
                        <div class="clear"></div>
