...
function sharing_display( $text = '' ) {
	...
	if ( $show ) {
		...
		if ( count( $enabled['all'] ) > 0 ) {
			...
			$visible .= '<li class="share-'.$service->get_class().' share-regular">';
			$visible .= '<iframe id="sharebutton" src="//www.facebook.com/plugins/like.php?href=http%3A%2F%2Fwww.solaregasmoniz.com&amp;send=false&amp;layout=button_count&amp;width=26&amp;show_faces=false&amp;action=like&amp;colorscheme=light&amp;font&amp;height=21" scrolling="no" frameborder="0"  allowTransparency="true"></iframe>';
			$visible .= '</li>';
